...
DROP POLICY IF EXISTS "Users can view their own installations" ON public.pwa_installations;
DROP POLICY IF EXISTS "Users can insert their own installations" ON public.pwa_installations;
DROP POLICY IF EXISTS "Admins can view all installations" ON public.pwa_installations;
