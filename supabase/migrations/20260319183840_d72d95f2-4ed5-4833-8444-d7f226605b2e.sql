-- Add 'routine' to all pro_link_type check constraints

ALTER TABLE user_tasks DROP CONSTRAINT user_tasks_pro_link_type_check;
...
ALTER TABLE routine_plan_tasks DROP CONSTRAINT routine_plan_tasks_pro_link_type_check;
...
ALTER TABLE admin_task_bank DROP CONSTRAINT admin_task_bank_pro_link_type_check;
