CREATE OR REPLACE FUNCTION public.provision_routine_for_user(
  p_user_id uuid,
  p_routine_id uuid
)
RETURNS jsonb
...
BEGIN
  ...
  -- Auto-enroll in linked program if this is a "program" type routine
