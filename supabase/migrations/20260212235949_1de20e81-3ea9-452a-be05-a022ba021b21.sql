...
-- Consolidated home page data function - replaces 12+ individual queries with 1 RPC call
...
DECLARE
  ...
  v_all_post_ids jsonb;
  v_read_post_ids jsonb;
  v_unread_count int;
...
BEGIN
  ...
  -- 3. Unread posts count (all posts minus read posts)
