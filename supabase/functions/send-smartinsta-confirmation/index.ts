  ...
  try {
    ...
    if (round?.id) {
      await supabase
        ...
        .eq("email", email)
        .is("round_id", null)
        .eq("source", "smartinsta_registration");
    }
...
<html dir="rtl" lang="fa">
  <body style="margin:0;padding:0;background:#fff7ed;font-family:Tahoma,Arial,sans-serif;color:#111827;">
    <div style="max-width:560px;margin:0 auto;padding:24px 20px;">
      ...
      <p style="margin:0 0 12px;font-size:13px;color:#7c3aed;font-weight:bold;">
    ...
    console.error("send-smartinsta-confirmation error", e);
