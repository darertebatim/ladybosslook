...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `A premium iOS app icon featuring an elegant minimalist crown silhouette, liquid glass aesthetic with frosted translucent effect, deep purple to magenta gradient background, subtle golden amber highlights and reflections, modern glassmorphism design with depth and layered transparency, soft glowing edges, professional app store quality, 1024x1024 square format, no text, centered composition, ultra high resolution`;
