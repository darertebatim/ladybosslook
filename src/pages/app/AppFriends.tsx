...
function FriendRow({
  ...
  return (
    <div className="rounded-3xl p-3 pl-4 bg-white/60 dark:bg-white/10 backdrop-blur-2xl shadow-ios flex items-center gap-3">
      ...
      <button
        onClick={onDedicate}
        className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full bg-[hsl(var(--brand-primary))] text-white text-sm font-semibold shadow-ios active:scale-95 transition-transform"
      >
