...
import { ArrowLeft, Send, Trash2, Mic, MicOff, Square, Sparkles } from 'lucide-react';
...
const QUICK_CHIPS = [
  ...
  { label: '🔄 I need a reset', prompt: 'I need a quick reset. Can you guide me through one?' },
  { label: '💭 How am I doing?', prompt: 'How am I doing based on my recent activity and mood?' },
  { label: '✨ Suggest a routine', prompt: 'Suggest a routine that would be good for me right now.' },
  { label: '😮‍💨 I\'m stressed', prompt: 'I\'m feeling stressed right now. Can you help?' },
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b bg-card safe-area-top">
        ...
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            <h1 className="text-base font-semibold truncate">Simora AI Coach</h1>
          ...
          <div className="flex flex-col items-center justify-center h-full gap-6 pb-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-muted-foreground max-w-xs">
                I'm your wellness coach. I can help you plan your day, manage routines, or just talk about how you're feeling.
              </p>
            </div>
