...
function convertToRoutinePlanTask(task: RoutineBankTask): RoutinePlanTask & { schedule_days?: number[] | null; drip_day?: number | null; repeat_pattern?: string | null; repeat_days?: number[] | null; time_period?: string | null } {
  return {
    id: task.id,
