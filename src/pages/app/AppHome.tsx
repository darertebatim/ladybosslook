  ...
  return (
    <>
      ...
      <div className="flex flex-col h-full overflow-hidden bg-background">
        ...
        <header className="tour-header fixed top-0 left-0 right-0 z-50 bg-white/20 dark:bg-black/15 backdrop-blur-xl rounded-b-xl" style={{
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            selectedTag === null
                              ...
                              : 'bg-white text-muted-foreground dark:bg-white/10 border border-white shadow-[inset_0_1px_0_rgba(255,255,255,0.9),inset_0_-1px_0_rgba(0,0,0,0.03),0_0_0_1px_rgba(0,0,0,0.02)]'
                          )}
                        >
                          All
                        </button>
