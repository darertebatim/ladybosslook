                ...
                <div>
                  ...
                  {(() => {
                    ...
                    return isFirstActionPending ? (
                      ...
                      <SortableTaskList tasks={filteredTasks} date={selectedDate} completedTaskIds={completedTaskIds} completedSubtaskIds={completedSubtaskIds} goalProgressMap={goalProgressMap} onTaskTap={handleTaskTap} onStreakIncrease={handleStreakIncrease} onOpenGoalInput={handleOpenGoalInput} onOpenTimer={handleOpenTimer} onOpenNewActionSheet={() => setShowQuickStart(true)} />
                    );
                  })()}
