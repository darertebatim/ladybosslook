              ...
              <div className="p-4 space-y-2.5">
                ...
                {course?.description && (
                  <div className="pt-0.5 relative">
                    <p className="text-sm text-fg-warm-muted whitespace-pre-line line-clamp-2 pr-[4.2em]">
                      {course.description}
                    </p>
                    <button
                      onClick={() => setDescOpen(true)}
                      className="absolute bottom-0 right-0 text-sm font-semibold text-brand active:opacity-70 transition-opacity bg-gradient-to-l from-card-warm via-card-warm to-transparent pl-6 pr-0"
                    >
                      ...more
                    </button>
                  </div>
