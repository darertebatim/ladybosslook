            ...
            <div className="space-y-6 mb-6">
              <div className="bg-muted p-6 rounded-lg">
                ...
                <p className="text-foreground/80 leading-relaxed">
                  برای دوره‌های با اشتراک ماهانه، فقط آخرین پرداخت قابل بازگشت است. می‌توانید تا پایان دوره ماهانه فعلی، درخواست بازگشت وجه برای همان ماه را ارسال کنید.
                </p>
              </div>
              ...
              <div className="bg-muted p-6 rounded-lg">
                ...
                <p className="text-foreground/80 leading-relaxed">
                  برای دوره‌های سه ماهه و بلندمدت‌تر، پس از گذشت یک ماه از شروع دوره، می‌توانید درخواست بازگشت وجه برای مدت باقیمانده دوره را ارسال کنید. مبلغ بازگشتی متناسب با مدت زمان باقیمانده از دوره محاسبه و به حساب شما بازگردانده خواهد شد.
                </p>
              </div>
