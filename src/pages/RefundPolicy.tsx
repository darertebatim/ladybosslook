            ...
            <div className="space-y-6 mb-6">
              <div className="bg-muted p-6 rounded-lg">
                <h3 className="text-xl font-medium text-foreground mb-3 font-farsi">
                  دوره‌های با اشتراک ماهانه
                </h3>
                <p className="text-foreground/80 leading-relaxed">
                  برای دوره‌های با اشتراک ماهانه، فقط آخرین پرداخت شما قابل بازگشت است. می‌توانید در هر زمان درخواست بازگشت وجه آخرین پرداخت خود را ارسال کنید.
                </p>
              </div>
              ...
              <div className="bg-muted p-6 rounded-lg">
                ...
                <p className="text-foreground/80 leading-relaxed">
                  برای دوره‌های سه ماهه و بلندمدت‌تر، پس از گذشت یک ماه از شروع دوره، می‌توانید درخواست بازگشت وجه برای مدت باقیمانده دوره را ارسال کنید. مبلغ بازگشتی به نسبت زمان باقیمانده محاسبه خواهد شد.
                </p>
              </div>
              ...
              <div className="bg-muted p-6 rounded-lg">
                ...
                <p className="text-foreground/80 leading-relaxed">
                  برنامه‌های دایموند و اکسلریتور به دلیل ماهیت ویژه و خدمات اختصاصی، مشمول گارانتی بازگشت وجه نمی‌شوند.
                </p>
              </div>
            </div>
          </section>
