          ...
          <CardContent className="p-4 md:p-6 space-y-4">
            ...
            <div className="text-center p-3 md:p-4 rounded-lg bg-primary/10 border border-primary/20">
              <div className="flex flex-col md:flex-row items-center justify-center gap-3 text-muted-foreground">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm md:text-base font-medium text-gray-900 dark:text-gray-100">سه‌شنبه ۲ سپتامبر</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4 md:w-5 md:h-5 text-primary" />
                  <span className="text-sm md:text-base font-medium text-gray-900 dark:text-gray-100">ساعت ۶ غروب</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center p-3 rounded-lg bg-primary/10 border border-primary/20">
              <p className="text-sm md:text-base font-semibold text-gray-900 dark:text-gray-100">
                💼 مناسب برای: 👩‍💼 خانم‌های کارمند • 👩‍💻 خانم‌های صاحب بیزینس • 👩‍🎓 دانشجویان
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 md:space-y-3">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-primary/5 border border-primary/10">
                  ...
                  <span className="text-sm md:text-base text-gray-900 dark:text-gray-100">چطور درآمدت رو افزایش بدی</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-secondary/5 border border-secondary/10">
                  ...
                  <span className="text-sm md:text-base text-gray-900 dark:text-gray-100">چطور در شغلت ارتقا بگیری</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-accent/5 border border-accent/10">
                  ...
                  <span className="text-sm md:text-base text-gray-900 dark:text-gray-100">چطور شرایط مالی خودت رو بسازی</span>
                </div>
              </div>
            </div>
