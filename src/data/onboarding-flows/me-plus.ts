...
export const mePlusFlow: OnboardingFlow = {
  ...
  steps: [
    ...
    // ─── PDF2 Page 12: Paywall 1 (7-day trial) ───────────
    {
      ...
      pricingTiers: [
        { label: 'Annual', perWeek: '$8.33/mo.', total: '$99.99/yr', badge: '7-Day Free Trial' },
        { label: 'Monthly', perWeek: '$13.99/mo.', total: '$13.99/mo' },
      ],
      buttonLabel: 'Continue',
    ...
    // ─── PDF2 Page 14: Countdown Paywall ──────────────────
    {
      ...
      statHighlight: '50% OFF',
      pricingTiers: [
        { label: 'Annual', perWeek: '$8.33/mo.', total: '$99.99/yr', badge: '58% OFF' },
        { label: 'Monthly', perWeek: '$13.99/mo.', total: '$13.99/mo' },
      ],
      buttonLabel: 'Continue',
