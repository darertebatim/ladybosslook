...
import { X, History, Sparkles, Check, Flame, BarChart2, Heart } from 'lucide-react';
      ...
      <div className="fixed inset-0 z-10 flex flex-col overflow-hidden">
        ...
        >
          ...
          <button
            ...
            className={cn(
              "w-full h-12 rounded-full flex items-center justify-center gap-2 font-medium transition-all active:scale-[0.98]",
              isAdded 
