...
const HELP_FAQ = [
  ...
  { q: 'How does a subscription work?', a: 'Ladybosslook+ is a recurring subscription that gives you access to all premium content. It renews automatically unless cancelled.' },
...
export function SubscriptionCard() {
  ...
  const planLabel = isAnnual ? 'Ladybosslook+ Yearly' : 'Ladybosslook+ Monthly';
