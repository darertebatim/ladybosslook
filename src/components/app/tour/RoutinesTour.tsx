  ...
  const steps = useMemo((): TourStep[] => [
    ...
    },
    {
      id: 'actions-section',
       ...
       description: 'Individual tasks live here. Each one can be added to your planner separately.',
       position: 'top',
      action: 'look',
    ...
    },
    {
      ...
      target: '.tour-action-add-btn',
       ...
       description: 'Tap the + button to add any task to your daily planner. Customize time, repeat, and reminders.',
      position: 'left',
      action: 'tap',
