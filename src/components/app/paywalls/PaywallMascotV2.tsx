  ...
  if (page === 1) return (
    <div ref={containerRef} style={{ position: 'relative', minHeight: '100%', background: '#fff', fontFamily: SF }}>
      ...
      <div style={{
        ...
        <img src={mascotHero} alt="" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', <img src={mascotHero} alt="" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 45%' }} /> }} />
