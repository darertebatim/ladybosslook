  ...
  return (
      ...
      >
        ...
        <button
          ...
          className="absolute top-2 right-2 z-10 p-1 rounded-full bg-black/25 active:bg-black/40 transition-colors"
          aria-label="Dismiss"
        >
          <X className="h-3.5 w-3.5 text-white" />
        </button>

        <div className="absolute inset-0 z-[1] flex items-center gap-3 px-3.5 pr-4">
          <div
          ...
          <div className="flex-1 min-w-0">
            <p className="text-white text-[14px] font-bold leading-tight line-clamp-2">
              Discover your self-care gaps in 1 min
            </p>
            <div className="mt-1.5 inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-white text-[#EB5E33]">
