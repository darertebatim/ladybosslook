        ...
        {isLocked && (
          <>
            <img 
              src={chainLockImg} 
              alt="" 
              className="absolute -top-5 -left-4 w-12 h-16 pointer-events-none drop-shadow-lg z-10"
            />
            <div className="absolute top-2 right-2 w-7 h-7 rounded-full bg-foreground/80 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-background"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
            </div>
          </>
        )}
      </button>
