...
const MyLearningMock = lazy(() => import("@/pages/admin/MyLearningMock"));
...
const LearnCoursesAdmin = lazy(() => import("@/pages/admin/LearnCourses"));
                ...
                <Routes>
                  ...
                  {!isNativeApp() && (
                    <Route path="/admin" element={<AdminLayout />}>
                      ...
                      <Route path="brand/learning-mock" element={<ProtectedRoute requiredPage="system"><MyLearningMock /></ProtectedRoute>} />
                  ...
                  {!isNativeApp() && <Route path="/elclanding" element={<ElcLanding />} />}
                  ...
                  {/* Legacy pre pages redirect to thank-you pages (old emails still link here) */}
                  {!isNativeApp() && <Route path="/presixtraps" element={<Navigate to="/thankyousixtraps" replace />} />}
