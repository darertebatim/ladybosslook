...
const TABS = [
  ...
  { to: "/aperture/app/playbooks",    label: "Plays",
  ...
  { to: "/aperture/app/chat",         label: "Chat",
  ...
  { to: "/aperture/app/integrations", label: "More",
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><circle cx="5" cy="12" r="1.5"/><circle cx="12" cy="12" r="1.5"/><circle cx="19" cy="12" r="1.5"/></svg> },
];
