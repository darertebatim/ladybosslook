...
const TABS = [
  { to: "/aperture/brand/mockup",              label: "Home",     end: true,
  ...
  { to: "/aperture/brand/mockup/chats",        label: "Chats",
  ...
  { to: "/aperture/brand/mockup/memory",       label: "Memory",
  ...
  { to: "/aperture/brand/mockup/library",      label: "Library",
